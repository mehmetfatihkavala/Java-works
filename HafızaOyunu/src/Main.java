...
public class Main {
    ...
    public static void tahminEt(){
        ...
        System.out.println("Birinci Tahmin(i ve j tahminlerini bir boşlık bırakarak giriniz...");
        ...
        System.out.println("İkinci Tahmin(i ve j tahminlerini bir boşlık bırakarak giriniz...");
        int i2 = scanner.nextInt();
        int j2 = scanner.nextInt();
        
        if(kartlar[i1][j1].getDeger() == kartlar[i2][j2].getDeger()){
            System.out.println("Halal olsın dayiogliii...");
            kartlar[i2][j2].setTahmin(true);
        }
        else{
            System.out.println("Fıssss...");
